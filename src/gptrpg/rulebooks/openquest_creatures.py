...
OPENQUEST_GOBLIN = Entity(
    ...
    stats=(
        ...
        StatEntry(name="CON", form="numeric", current=10),
        StatEntry(name="DEX", form="numeric", current=17),
        StatEntry(name="SIZ", form="numeric", current=7),
        StatEntry(name="INT", form="numeric", current=11),
        StatEntry(name="POW", form="numeric", current=10),
        StatEntry(name="CHA", form="numeric", current=7),
        ...
        StatEntry(name="Armour Points", form="numeric", current=2),
    ),
)
...
OPENQUEST_SKELETON = Entity(
    ...
    rulebook_id=OPENQUEST_ID,
    stats=(
        StatEntry(name="STR", form="numeric", current=13),
        StatEntry(name="CON", form="numeric", current=4),
        StatEntry(name="DEX", form="numeric", current=11),
        StatEntry(name="SIZ", form="numeric", current=11),
        # 스켈레톤은 지력·의지·매력이 없다 — 0이 정상이고 거부되지 않는다.
        StatEntry(name="INT", form="numeric", current=0),
        StatEntry(name="POW", form="numeric", current=0),
